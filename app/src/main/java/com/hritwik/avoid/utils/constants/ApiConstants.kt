...
object ApiConstants {
    ...
    const val IMAGE_TYPES_PRIMARY_ONLY = "Primary"
    ...
    const val FIELDS_MINIMAL = "PrimaryImageAspectRatio,Year,UserData"
    const val FIELDS_STANDARD = "PrimaryImageAspectRatio,Year,Genres,Overview,UserData,ParentIndexNumber,IndexNumber"
    const val FIELDS_FULL = "BasicSyncInfo,CanDelete,PrimaryImageAspectRatio,Year,Genres,Studios,People,Overview,Taglines,MediaSources,MediaStreams,ParentIndexNumber,IndexNumber,UserData,ProviderIds"
    const val FIELDS_RESUME = "PrimaryImageAspectRatio,SeriesInfo,UserData,Overview,ParentIndexNumber,IndexNumber"
    const val FIELDS_NEXT_UP = "PrimaryImageAspectRatio,SeriesInfo,UserData,Overview,ParentIndexNumber,IndexNumber"
    const val IMAGE_TYPES_RESUME = "Primary,Backdrop" // prefer primary for episodes, fallback to backdrop
    const val IMAGE_TYPES_NEXT_UP = "Thumb"   // lighter for next up rows
    const val IMAGE_TYPES_ENHANCED = "Primary,Backdrop,Thumb"
}
